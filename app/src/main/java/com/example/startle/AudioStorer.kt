...
class AudioStorer(var context: Context) {//similar to the imageStorer and stores the added audio into shared preferences
    ...
    fun storeAudios(audios:List<AudioModel>){//to store audio into list of audioModel objects
        val gson = Gson()
    ...
    fun getAllAudios(): List<AudioModel>{
        ...
        assetAudios.add(AudioModel(3, "scream1", "Scream 1", true))
